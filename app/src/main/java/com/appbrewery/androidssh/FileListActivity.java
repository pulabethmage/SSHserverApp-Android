...
import com.appbrewery.androidssh.adapters.FileListAdapter;
import com.appbrewery.androidssh.adapters.RemoteFileListAdapter;
import com.appbrewery.androidssh.sshutils.SessionController;
import com.appbrewery.androidssh.sshutils.TaskCallbackHandler;
...
public class FileListActivity extends Activity implements OnItemClickListener, OnClickListener, OnDragListener {
    ...
    public void onItemClick(AdapterView<?> arg0, View arg1, int position, long arg3) {
        ...
        if (mFilenames.get(position).isDirectory()) {
            ...
            mSessionController.uploadFiles(arr, progressDialog,FolderName);
        }
