...
public class SftpController {
    ...
    public class UploadTask extends AsyncTask<Void, Void, Boolean> {
        ...
        public UploadTask(Session session, File[] localFiles, SftpProgressMonitor spd,String FolderName) {
        ...
        protected Boolean doInBackground(Void... voids) {
            ...
            try {
                uploadFiles(mSession, mLocalFiles, mProgressDialog,folderName);
...
//    public DeleteTask(String DeleteFileName) {
//
//
...
//
    ...
    public class DeleteTask extends AsyncTask<Void, Void, Boolean> {
        ...
        public DeleteTask(Session session,String DeleteFileName,String DeleteFolderName) {
        ...
        protected Boolean doInBackground(Void... voids) {
            ...
            boolean success = true;
            try {
                deleteFiles(mSession,deleteFileName,deleteFolderName);
            } catch (JSchException e) {
                e.printStackTrace();
                Log.e(TAG, "JSchException " + e.getMessage());
                success = false;
    ...
    public void deleteFiles(Session session,String deleteFileName,String deletefolderName) throws JSchException, IOException, SftpException {
        ...
        try {
            channelSftp.cd(deletefolderName);
     ...
     */
    public void uploadFiles(Session session, File[] localFiles, SftpProgressMonitor spm,String folderName) throws JSchException, IOException, SftpException {
        if (session == null || !session.isConnected()) {
            session.connect();
        }
