...
public class SessionController {
     ...
     */
    public void uploadFiles(File[] files, SftpProgressMonitor spm, String folderName) {
        if (mSftpController == null) {
            mSftpController = new SftpController();

        }
        mSftpController.new UploadTask(mSession, files, spm,folderName).execute();
    }

    public void deleteFiles(String fileDeleteName,String folderDeleteName) {
        if (mSftpController == null) {
            mSftpController = new SftpController();

        }
        mSftpController.new DeleteTask(mSession,fileDeleteName,folderDeleteName).execute();
    }
